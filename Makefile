# This Makefile is for the IO::Lambda::Socket::TCPServer extension to perl.
#
...
#     NAME => q[IO::Lambda::Socket::TCPServer]
#     PREREQ_PM => { Test::More=>q[0.32] }
#     VERSION_FROM => q[lib/IO/Lambda/Socket/TCPServer.pm]
...
NAME_SYM = IO_Lambda_Socket_TCPServer
VERSION = 0.01
...
MAKE = make
FULLEXT = IO/Lambda/Socket/TCPServer
BASEEXT = TCPServer
PARENT_NAME = IO::Lambda::Socket
DLBASE = $(BASEEXT)
VERSION_FROM = lib/IO/Lambda/Socket/TCPServer.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/IO/Lambda/Socket/TCPServer.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/IO/Lambda/Socket
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/IO/Lambda/Socket
...
TO_INST_PM = lib/IO/Lambda/Socket/TCPServer.pm

PM_TO_BLIB = lib/IO/Lambda/Socket/TCPServer.pm \
	blib/lib/IO/Lambda/Socket/TCPServer.pm
...
DISTNAME = IO-Lambda-Socket-TCPServer
DISTVNAME = IO-Lambda-Socket-TCPServer-0.01
...
manifypods : pure_all  \
	lib/IO/Lambda/Socket/TCPServer.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/IO/Lambda/Socket/TCPServer.pm $(INST_MAN3DIR)/IO::Lambda::Socket::TCPServer.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                IO-Lambda-Socket-TCPServer' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Test::More:                    0.32' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Test-More" VERSION="0,32,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/IO/Lambda/Socket/TCPServer.pm blib/lib/IO/Lambda/Socket/TCPServer.pm 
